...
start_date date,
end_date date,
primary key(course_code, faculty_code, start_date),
foreign key(course_code, faculty_code) references course(course_number, faculty_code),
...
faculty_code text,
start_date date,
primary key(instructor_name, course_code, faculty_code, start_date),
foreign key(course_code, faculty_code, start_date) references edition(course_code, faculty_code, start_date)
);
...
primary key(student, course_number, faculty_code, start_date),
foreign key(course_number, faculty_code, start_date) references edition(course_number, faculty_code, start_date)
);
...
insert into instructor values('Xander', 'male', NULL, 'ECE');
insert into faculty values('ECE', 'teaching', 'Engineering');
insert into course values(258, 'CSC', 'Computer Orginazition', 'computer science');
...
insert into edition values(258, 'CSC', 'evening', 258, '2015-09-08', '2016-04-30');
...
insert into of_faculty values('Xander', 'ECE', 2005);
...
insert into instructs values('Marina Barsky', 343, 'CSC', '2016-05-09');
insert into instructs values('Diane Horton', 207, 'CSC', '2015-09-08');
insert into instructs values('Diane Horton', 209, 'CSC', '2015-02-08');
insert into instructs values('Y. Zheng', 137, 'MAT','2015-02-08');
insert into instructs values('Xander', 258, 'CSC', '2015-09-08');
insert into instructs values('Bahar', 236, 'CSC','2015-09-08');
insert into instructs values('Bahar', 165, 'CSC', '2014-02-08');
insert into instructs values('Jeniffer', 108, 'CSC', '2013-09-01');
insert into instructs values('David Liu', 148, 'CSC', '2014-02-08');
insert into instructs values('Jeniffer', 148, 'CSC', '2014-02-08');
insert into instructs values('L. AI. Labadi', 247, 'STA', '2015-09-08');

insert into enrols_in values('c5caoye', 148, 'CSC', '2014-02-08', 74, 3);
insert into enrols_in values('c5caoye', 108, 'CSC', '2013-09-01', 100, 5);
insert into enrols_in values('c5caoye', 165, 'CSC', '2014-02-08', 90, 2);
insert into enrols_in values('c5caoye', 137, 'MAT', '2015-02-08', 74, 1);
insert into enrols_in values('c5caoye', 247, 'STA', '2015-09-08', 74, 3);
insert into enrols_in values('c4haojin', 258, 'CSC', '2015-09-08', 100, 5);
insert into enrols_in values('c4haojin', 343, 'CSC', '2016-05-09', 100, 5);
insert into enrols_in values('c5caoye', 209, 'CSC', '2015-02-08', 100, 5);
insert into enrols_in values('c4haojin', 207, 'CSC', '2015-09-08', 99, 1);
insert into enrols_in values('c4haojin', 236, 'CSC', '2015-09-08', 85, 4);
